  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="bg-card border border-[rgba(0,0,0,0.1)] rounded-[14px] p-4">
          <p className="text-foreground text-[12px] mb-1">Pending QC</p>
          <p className="text-[#FFA500] text-[24px] font-bold">{loading ? '—' : stats.pending}</p>
        </div>
        <div className="bg-card border border-[rgba(0,0,0,0.1)] rounded-[14px] p-4">
          <p className="text-foreground text-[12px] mb-1">Total Receipts</p>
          <p className="text-foreground text-[24px] font-bold">{loading ? '—' : stats.received}</p>
        </div>
        <div className="bg-card border border-[rgba(0,0,0,0.1)] rounded-[14px] p-4">
          <p className="text-foreground text-[12px] mb-1">Fully Accepted</p>
          <p className="text-primary text-[24px] font-bold">{loading ? '—' : stats.fullyAccepted}</p>
        </div>
        <div className="bg-card border border-[rgba(0,0,0,0.1)] rounded-[14px] p-4">
          <p className="text-foreground text-[12px] mb-1">With Rejections</p>
      ...
      {pending.length > 0 && (
        <div className="bg-card border border-[rgba(0,0,0,0.1)] rounded-[14px] p-5 mb-6">
