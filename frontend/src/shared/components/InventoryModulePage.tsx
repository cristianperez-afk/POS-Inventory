          ...
          <div className="flex h-full flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto px-6 pb-6 pt-4">
              <Suspense fallback={<div className="flex h-full items-center justify-center text-sm text-slate-500">Loading inventory...</div>}>
                {isRestaurant ? renderRestaurantPage(currentPage, currentUser) : renderRetailPage(currentPage, inventoryUser, currentUser)}
              </Suspense>
            </div>
          </div>
        </div>
...
function renderRetailPage(page: Page, currentUser: InventoryUser | null, authenticatedUser: AuthenticatedUser | null): ReactNode {
  switch (page) {
