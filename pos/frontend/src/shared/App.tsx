...
function getDefaultPageForUser(user: AuthenticatedUser): Page {
  ...
  if (user.role === 'STAFF' && user.staff_type === 'INVENTORY_STAFF') return 'inventory-dashboard';
  if (user.role === 'STAFF' && user.staff_type === 'MANAGER') return 'inventory-dashboard';
